...
object SanelyJsoniter:
  ...
  inline def derivedStrict[A](using inline m: Mirror.Of[A]): JsonValueCodec[A] =
  ...
  private def deriveMacroStrict[A: Type](mirror: Expr[Mirror.Of[A]])(using Quotes): Expr[JsonValueCodec[A]] =
