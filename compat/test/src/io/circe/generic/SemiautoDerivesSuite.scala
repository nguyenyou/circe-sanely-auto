...
object SemiautoDerivesSuite {
  case class Box[A](a: A)
  object Box {
    given [A: Decoder]: Decoder[Box[A]] = deriveDecoder
    given [A: Encoder]: Encoder.AsObject[Box[A]] = deriveEncoder
  ...
  object Qux {
    given [A: Encoder.AsObject : Decoder]: Codec.AsObject[Qux[A]] = deriveCodec
  ...
  object Wub {
    given Codec.AsObject[Wub] = deriveCodec
  ...
  object Bam {
    given Codec.AsObject[Bam] = deriveCodec
  ...
  object Foo {
    given Codec.AsObject[Foo] = deriveCodec
  ...
  object BaseAdtExample:
    given Codec.AsObject[BaseAdtExample] = deriveCodec
  case class NestedAdtExample(r: RecursiveAdtExample) extends RecursiveAdtExample
  object NestedAdtExample:
    given Codec.AsObject[NestedAdtExample] = deriveCodec
  object RecursiveAdtExample {
    given Codec.AsObject[RecursiveAdtExample] = deriveCodec
  ...
  object RecursiveWithOptionExample {
    given Codec.AsObject[RecursiveWithOptionExample] = deriveCodec
  ...
  enum Vegetable:
    ...
    case Turnip
  object Vegetable:
    given Codec.AsObject[Vegetable] = deriveCodec
  ...
  object RecursiveEnumAdt:
    given Codec.AsObject[RecursiveEnumAdt] = deriveCodec
  ...
  object ADTWithSubTraitExample:
    given Codec.AsObject[ADTWithSubTraitExample] = deriveCodec
  ...
  object ProductWithTaggedMember:
    given Codec.AsObject[ProductWithTaggedMember] = deriveCodec
    sealed trait Tag
  ...
  object Inner:
    given [A: Encoder]: Encoder.AsObject[Inner[A]] = deriveEncoder
    given [A: Decoder]: Decoder[Inner[A]] = deriveDecoder
  case class Outer(a: Option[Inner[String]])
  object Outer:
    given Encoder.AsObject[Outer] = deriveEncoder
    given Decoder[Outer] = deriveDecoder
  ...
  object LongClass:
    given Encoder.AsObject[LongClass] = deriveEncoder
    given Decoder[LongClass] = deriveDecoder
  ...
  object LongEnum:
    given Encoder.AsObject[LongEnum] = deriveEncoder
    given Decoder[LongEnum] = deriveDecoder
  ...
  object LongSum:
    given Encoder.AsObject[LongSum] = deriveEncoder
    given Decoder[LongSum] = deriveDecoder
...
class SemiautoDerivesSuite extends CirceMunitSuite {
  import SemiautoDerivesSuite.*
