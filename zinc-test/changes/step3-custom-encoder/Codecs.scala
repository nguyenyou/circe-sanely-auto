...
object Codecs:
  // Custom encoder takes priority over auto-derived
  given Encoder.AsObject[User] = Encoder.AsObject.instance { u =>
    JsonObject("custom" -> Json.True, "name" -> Json.fromString(u.name))
  }
